...
@Aspect
@Component
public class BankAmountTransferCreditAspect {
	Log log=LogFactory.getFactory().getInstance(BankAmountTransferCreditAspect.class);
	
	@Pointcut("execution(* com.ranjit.bank.dao.impl.BankAmountTransferDAOImpl.creditAmount(..)) within(com.ranjit.bank.services.impl.BankServicesImpl)")
	public void dummy() {}
