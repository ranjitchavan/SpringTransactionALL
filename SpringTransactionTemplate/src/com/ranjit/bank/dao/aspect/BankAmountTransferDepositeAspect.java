...
@Aspect
@Component
public class BankAmountTransferDepositeAspect {
	Log log=LogFactory.getFactory().getInstance(BankAmountTransferDepositeAspect.class);
	
	@Pointcut("execution(* com.ranjit.bank.dao.impl.DepositeDAOImpl.depositeAmount(..)) within(com.ranjit.bank.services.impl.BankServicesImpl)")
	public void dummy() {}
